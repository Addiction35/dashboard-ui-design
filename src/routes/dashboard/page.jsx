                        ...
                        <table className="table">
                            <thead className="table-header">
                                <tr className="table-row">
                                    ...
                                    <th className="table-head">PURCHASE ORDER</th>
                                    <th className="table-head">REFERENCE</th>
                                    <th className="table-head">AMOUNT</th>
                                    <th className="table-head">VENDOR NAME</th>
                                    <th className="table-head">STATUS</th>
                                    <th className="table-head">BILLED</th>
                            ...
                            <tbody className="table-body">
                                {topProducts.map((product) => (
                                    ...
                                    >
                                        ...
                                        <td className="table-cell text-blue-500 dark:text-blue-600">{product.PO_No}</td>
                                        <td className="table-cell">{product.ref}</td>
                                        <td className="table-cell ">KES{product.price}</td> {/** AMOUNT */}
                                        <td className="table-cell">{product.vendor}</td>
                                        <td className="table-cell">{product.status}</td>
                                        <td className="table-cell">{product.billed}</td>
                                        <td className="table-cell">{product.D_date}</td>
                                        <td className="table-cell">
